                    ...
                    @foreach ($departemen as $index => $dept)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 flex space-x-4">
                                <a href="{{ route('admin.departemen.edit', $dept->departemen_id) }}" class="text-blue-500 hover:underline flex items-center">
                                    <i class="fas fa-edit mr-1"></i>
                                    Edit
                                </a>
                                <form action="{{ route('admin.departemen.destroy', $dept->departemen_id) }}" method="POST" onsubmit="return confirmDelete(event)" class="inline">
                                    @csrf
                                    @method('DELETE')
